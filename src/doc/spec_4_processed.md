...
Implementation in progress for SPEC 4. The scope is a visualization layer over existing SPEC 3 outputs: heatmap PNGs, alert peak images, overlay videos, JSON index/stats, and a qualitative Markdown report. The scoring formula is unchanged.
